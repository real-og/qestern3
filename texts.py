...
task6 = 'Координатор локации подскажет вам, как выполнить задание.'

task7 = "Сканируйте QR-код, чтобы узнать задание. Задание проверит координатор в мастер-локации."

congrats = """Поздравляем вас с успешным прохождением QR-квеста!
Пройдите в шатёр и разместитесь вашей командой за одним столом.
С ДНЁМ ШАХТЁРА!"""
